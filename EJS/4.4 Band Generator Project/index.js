...
function randomBandNameGenerator(adj, noun) {
  if(adj.length === 0 ){
    return undefined;
  }
  ...
  return adj[randomIndex] +" "+ noun[randomIndex];
}
...
app.post("/submit", (req, res) => {
  ...
  // console.log(randomBandNameGenerator(adj, noun));
  res.render("index.ejs", { bandName: randomBandNameGenerator(adj, noun) });
});
